...
imageBlob = cv2.dnn.blobFromImage(
    cv2.resize(image, (500, 500)), 1.0, (1000, 1000),
...
for i in range(0, detections.shape[2]):
    ...
    if confidence > args["confidence"]:
        ...
        x=str(k)
        text2 = "Total:"+x
        #cv2.putText(image, x, (startX, y), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 0, 255), 2)
    print(k)
# show the output image
cv2.putText(image, text2, (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

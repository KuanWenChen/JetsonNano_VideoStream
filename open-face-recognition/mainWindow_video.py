...
class MyDialog(QDialog):
    ...
    def initUI(self):
        ...
        # self.horizontalSlider.setGeometry(QtCore.QRect(1120, 690, 241, 22))
        ...
        self.sliderValueLabel.setFont(font)
    ...
    def showVedioStrem(self):
        ...
        while True:
            ...
            for i in range(0, detections.shape[2]):
                ...
                if (confidence > (self.sliderValue / 100.0)):
                    # print(confidence,"__", self.sliderValue / 100.0)
                    ...
                    self.crop_img = copy.deepcopy(face)
                    (fH, fW) = face.shape[:2]
